...
import pl.edu.agh.semsimmon.registries.jmx.discovery.node.JvmDiscoveryAgent;
...
public class JvmDiscoveryAgentTest {
  ...
  public void testDiscovery() throws IOException {
    ...
    Resource parent = new Resource("semsimmon://localhost/app1/clu1/node1", KnowledgeConstants.NODE_URI,
