package pl.edu.agh.semmon.registries.jmx;
...
import static pl.edu.agh.semmon.common.api.knowledge.KnowledgeConstants.*;
...
public class SpringConfigurationTest extends AbstractTestNGSpringContextTests {
  ...
  public void registerDeregisterTest() throws TransportException {
    ...
    Resource testNodeResource = new Resource("semmon://localhost/app1/clu1/node1", NODE_URI, props);
