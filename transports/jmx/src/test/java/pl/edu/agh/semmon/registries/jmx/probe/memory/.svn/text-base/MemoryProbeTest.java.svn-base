package pl.edu.agh.semmon.registries.jmx.probe.memory;
...
public class MemoryProbeTest {
  ...
  public void doTest() throws IOException {
    ...
    Resource physicalMem = new Resource("semmon://localhost/app1/clu1/node1/PhysicalMemory",
        KnowledgeConstants.PHYSICAL_MEMORY_URI, Collections.<String, Object>emptyMap());
    Resource virtualMem = new Resource("semmon://localhost/app1/clu1/node1/VirtualMemory",
