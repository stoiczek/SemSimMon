...
import pl.edu.agh.semmon.registries.jmx.discovery.node.CPUDiscoveryAgent;
...
public class CpuDiscoveryAgentTest {
  ...
  public void testDiscovery() throws IOException {
    ...
    Resource parent = new Resource("semmon://localhost/app1/clu1/node1", KnowledgeConstants.NODE_URI, Collections.<String, Object>emptyMap());
