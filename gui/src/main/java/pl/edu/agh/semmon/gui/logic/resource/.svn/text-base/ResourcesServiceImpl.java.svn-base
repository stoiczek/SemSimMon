...
import pl.edu.agh.semmon.common.util.JmxUrlParsingUtil;
...
import pl.edu.agh.semmon.gui.logic.resource.tree.ResourcesTree;
...
public class ResourcesServiceImpl implements ResourcesService, ResourceEventsListener {
  ...
  private static final String SYNTHETIC_APPS_NAMESPACE = "semmon://";
