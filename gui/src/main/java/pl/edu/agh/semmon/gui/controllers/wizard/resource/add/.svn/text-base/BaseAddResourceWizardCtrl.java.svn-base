...
import pl.edu.agh.semmon.gui.controllers.wizard.BaseWizardController;
...
import pl.edu.agh.semmon.gui.logic.connection.ExternalCoreConnection;
import pl.edu.agh.semmon.gui.logic.connection.ExternalProcessCoreConnection;
