...
import pl.edu.agh.semmon.gui.controllers.dialog.AddMeasurementDialogController;
import pl.edu.agh.semmon.gui.controllers.tab.visualization.VisualizationController;
import pl.edu.agh.semmon.gui.controllers.wizard.resource.add.jmx.AddJMXResourceWizardController;
import pl.edu.agh.semmon.gui.controllers.wizard.resource.add.ocmg.AddOcmgResourceWizardController;
