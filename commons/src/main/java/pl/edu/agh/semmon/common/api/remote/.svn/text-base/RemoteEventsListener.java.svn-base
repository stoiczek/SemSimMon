package pl.edu.agh.semmon.common.api.remote;
...
public interface RemoteEventsListener extends  Remote {
   ...
   * @see pl.edu.agh.semmon.common.api.measurement.CapabilityValueListener#newCapabilityValues(java.util.List)
   * @param values values
   ...
   * @see pl.edu.agh.semmon.common.api.resource.ResourceEventsListener#processEvent(pl.edu.agh.semmon.common.api.resource.ResourceEvent)
   * @param events events
