...
import pl.edu.agh.semmon.common.exception.ResourceAlreadyRegisteredException;
import pl.edu.agh.semmon.common.exception.ResourceNotRegisteredException;
import pl.edu.agh.semmon.common.exception.ResourcesException;
...
public interface CoreResourcesService {
   ...
   * @param type
   * @param parameters
   * @throws pl.edu.agh.semmon.common.exception.ResourceAlreadyRegisteredException
   *
   */
   ...
   * @param uri
   * @return
   * @throws pl.edu.agh.semmon.common.exception.ResourceNotRegisteredException
   *
   */
   ...
   *
   * @param resource
   * @throws pl.edu.agh.semmon.common.api.transport.TransportException
   */
